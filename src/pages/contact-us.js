...
export default function ContactPage() {
    return (
        <Layout>
            ...
            <div className="ps-0 ps-md-4 contact">
                ...
                <div className='pe-4 mb-5 d-none d-md-block'>
                    <div className='' style={{ backgroundColor: '#F1F1F1', height: '70px' }}>

                    </div>
                </div>
                <div className="d-flex d-md-none flex-row col-10 mx-auto " >
                    <div className="" >
                        <div className="h-75 overflow-auto d-flex flex-column justify-content-center">
                            <div className="thirdbg rounded-3 p-4 text-black bg-light h-75 overflow-auto">
                                <div className="p-3 bg-white rounded-3 d-flex flex-column align-items-center overflow-auto">
                                    <h1 className="felix_regular">Contact Us</h1>
                                    <p className="text-center manrope_regular" style={{ color: '#67748E', fontSize: '12px' }}>
                                        For further enquiries, partnerships, please email hello@creative-
                                        tim.com or fill the form below.
                                    </p>
